...
// var arr = ['CRICKET', 'FOOTBALL', 'BASKETBALL', 'SWIMMING', 'TABLE TENNIS', 'VOLLYBALL', 'TENNIS', 'BADMINTON']
...
// var arr = ['allama iqbal', 'babar azam', 'quaid-e-azam', 'shahid afridi', 'dr zakir naiq', 'molana tariq jameel', 'mohammad amir']
// for (var i = 0; i<arr.length; i++){
